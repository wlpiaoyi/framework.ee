 ...
 * {@code @description:} 	文件夹 Mapper 接口
...
public interface FolderMapper extends BaseMapper<Folder> {
     ...
     * @return
     */
    int insertAll(@Param("item") Folder entity);
	 ...
	 * @return
	 */
	int insertAllBatch(@Param("items") List<Folder> list);
	 ...
	 * @return
	 */
	int updateAll(@Param("item") Folder entity);
	 ...
	 * @return
	 */
	int updateAllBatch(@Param("items") List<Folder> list);
